...
/**
 * External function to delete a question from a reflect activity.
 *
 * @package mod_reflect
...
class delete_question extends external_api {
    ...
    /**
     * Delete a question and its associated responses.
     *
    ...
    public static function execute(int $cmid, int $questionid): array {
        ...
        $DB->delete_records('reflect_responses', ['questionid' => $params['questionid']]);
        $DB->delete_records('reflect_questions', ['id' => $params['questionid']]);
